#!/usr/bin/env python3
"""Run the four key V18 points with multiple random seeds."""
...
from pipeline_common import ABLATIONS, CORE_POINTS, ROOT, Job, completed_run
...
def main() -> None:
    ...
    point_ids = list(CORE_POINTS) if "all" in args.points else list(
        dict.fromkeys(args.points)
    )
    jobs = [
        Job(*CORE_POINTS[point], seed, args.ablation)
