#!/usr/bin/env python3
"""Train one V15 dataset/mask/rate combination with deterministic config merging."""
...
DATASETS = {
    "TaxiBJ": {
        ...
        "model": "configs/v15-single/taxibj.json",
    ...
    "BikeNYC": {
        ...
        "model": "configs/v15-single/bikenyc.json",
    ...
    "CHAP": {
        ...
        "model": "configs/v15-single/chap.json",
...
ABLATIONS = {
    "no_pyramid": "no_pyramid.json",
    "fixed_budget": "fixed_budget.json",
    "unbounded_residual": "unbounded_residual.json",
    "no_base_loss": "no_base_loss.json",
    "no_delta_loss": "no_delta_loss.json",
    "no_safety_loss": "no_safety_loss.json",
}
...
def main() -> None:
    ...
    run_name = "full" if args.ablation == "none" else f"ablation_v15_{args.ablation}"
    with tempfile.TemporaryDirectory(prefix="v15_single_") as directory:
