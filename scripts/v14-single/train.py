#!/usr/bin/env python3
"""Train one V14 dataset/mask/rate combination with deterministic config merging."""
...
DATASETS = {
    "TaxiBJ": {
        ...
        "model": "configs/v14-single/taxibj.json",
    ...
    "BikeNYC": {
        ...
        "model": "configs/v14-single/bikenyc.json",
    ...
    "CHAP": {
        ...
        "model": "configs/v14-single/chap.json",
...
ABLATIONS = {
    "main": "main_fallback.json",
    "no_dynamic_gate": "no_dynamic_gate.json",
    "no_difficulty": "no_difficulty.json",
    "no_observed_consistency": "no_observed_consistency.json",
    "no_regret_guard": "no_regret_guard.json",
    "no_multiscale_supervision": "no_multiscale_supervision.json",
    "no_fine_protection": "no_fine_protection.json",
    "no_main_bypass": "no_main_bypass.json",
}
...
def main() -> None:
    ...
    if args.training_policy:
        ...
        patch = _deep_update(patch, {
            "experiment_policy": {"name": policy.get("name", policy_path.stem), "source": str(policy_path)}
        })
