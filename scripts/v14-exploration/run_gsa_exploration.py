#!/usr/bin/env python3
"""Run V14 gradient-scaled stage-supervision exploration on one GPU."""
...
CONFIGS = {
    "G01": CONFIG_ROOT / "G01_stage_aux_off.json",
    "G02": CONFIG_ROOT / "G02_stage_aux_scale_1e-3.json",
    "G03": CONFIG_ROOT / "G03_stage_aux_scale_1e-2.json",
}
SCREEN_POINTS = (
    ("TaxiBJ", "fixed", "0.4"),
    ("BikeNYC", "random", "0.8"),
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=None,
        help="Required after screen; choose from validation metrics only.",
    )
