...
def compact_v14_config(
    ...
    v14 = json.loads((ROOT / "configs/v14-single/smoke.json").read_text(encoding="utf-8"))
    cfg = deep_update(base, v14)
    return deep_update(cfg, {
        ...
        "train": {"amp": False, "lr_main": 1e-3, "lr_v14": 1e-2},
    })
