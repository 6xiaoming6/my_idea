...
def compact_v15_config(
    ...
    v15 = json.loads((ROOT / "configs/v15-single/smoke.json").read_text(encoding="utf-8"))
    cfg = deep_update(base, v15)
    return deep_update(cfg, {
        ...
        "train": {"amp": False, "lr_main": 1e-3, "lr_v15": 1e-2},
    })
