...
LAUNCHER = BENCH / "run_all_baseline_train_2gpu.py"
POLICY = BENCH / "policies" / "taxibj_full_no_diffusion.json"
MODELS = (
...
def main() -> None:
    ...
    command = [
        ...
        "--run-root", "imputation_benchmark/taxibj_full_runs",
    ]
    if args.resume_run:
    ...
    lock_path = BENCH / "taxibj_full_runs" / ".single_gpu.lock"
