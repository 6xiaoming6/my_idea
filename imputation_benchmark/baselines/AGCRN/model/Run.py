...
#parser
args.add_argument('--dataset', default=config['data']['dataset'], type=str)
...
#data
args.add_argument('--data_prefix',default=config['data']['data_prefix'],type=str)
args.add_argument('--type',default=config['data']['type'],type=str)
args.add_argument('--miss_rate',default=config['data']['miss_rate'],type=float)
...
#train
args.add_argument('--use_nni', default=config['train']['use_nni'], type=int)
...
if args.use_nni:
    ...
    args.embed_dim = int(params['embed_dim'])
    args.rnn_units = int(params['rnn_units'])
    args.num_layers = int(params['num_layers'])
    args.cheb_order = int(params['cheb_order'])
